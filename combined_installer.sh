...
SCRIPTS[4]="setup_programs_slamanv_shortcut.sh"
SCRIPTS[5]="setup_sensor2.sh"
SCRIPTS[6]="setup_system_build_env_s100-2.sh"
...
print_menu() {
  ...
  echo "  4) setup_programs_slamanv_shortcut.sh"
  echo "  5) setup_sensor2.sh"
  echo "  6) setup_system_build_env_s100-2.sh"
  echo "  a) 모두 설치"
}
